        ...
        <div className="contact-grid">
          <Card className="contact-card" title="关于作者">
            <Typography.Paragraph>
              ...
              经验，长期做 Web 产品与工具类项目。技术栈覆盖 <strong>Java</strong>、
              <strong>Python</strong> 等后端方向，也熟悉前端工程化与部署； 对
              <strong>逆向分析</strong>、协议与系统底层有一定实践，习惯从问题出发把链路打通。
            </Typography.Paragraph>
          ...
          <Card className="contact-card" title="微信联系">
            <div className="contact-wechat">
              <WechatOutlined
                aria-hidden
                style={{ fontSize: 28, color: "var(--color-accent-green, #788c5d)" }}
              />
            ...
            <Typography.Paragraph type="secondary" className="contact-wechat-hint">
