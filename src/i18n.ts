...
export const I18N = {
  zh: {
    ...
    commentEditorTitle: "编辑 COMMENT",
    commentEditorLead: "改这里就会写回注释，不用去改 SQL 语句。",
    commentEditorTable: "表注释",
    commentEditorPlaceholder: "可空",
    commentEditorApply: "应用到图",
    commentEditorEmpty: "先生成 ER 图，再改注释",
    commentEditorOpen: "编辑 COMMENT",
    ...
    tipShowAttrs: "显示属性",
    tipHideAttrs: "隐藏属性",
    tipHideRelations: "关闭关联",
    tipShowRelations: "打开关联",
    tipForceOn: "开启持续力导向",
    tipForceOff: "关闭持续力导向",
    ...
    shareReadonlyBannerAuthed: "只读分享 · 这份图不能改，可去生成器做自己的",
    shareLoginToEdit: "登录编辑",
    shareOpenGenerator: "打开生成器",
    shareLoading: "加载分享…",
    shareNotFoundTitle: "分享不存在或已过期",
    shareNotFoundHint: "链接可能已失效，请联系分享者重新生成。",
    shareGalleryTitle: "表",
    shareGalleryLead: "每张表单独一张卡，点击可预览。",
    shareCardPreview: "点击预览",
    sharePreviewHint: "拖动画布 · 滚轮缩放 · Esc 关闭",
    warnTitle: "解析警告",
    warnDismiss: "关闭解析警告",
    warnMore: "还有 {n} 条",
    timeJustNow: "刚刚",
...
`,
  ...
  en: {
    ...
    commentEditorTitle: "Edit comments",
    commentEditorLead: "Change comments here instead of editing SQL.",
    commentEditorTable: "Table comment",
    commentEditorPlaceholder: "Optional",
    commentEditorApply: "Apply",
    commentEditorEmpty: "Generate the diagram first",
    commentEditorOpen: "Edit comments",
    ...
    tipHideRelations: "Hide relationships",
    tipShowRelations: "Show relationships",
    ...
    shareModalHint:
      "Anyone with the link can view the diagram. SQL and layout cannot be edited. Links expire after 90 days.",
    ...
    shareReadonlyBannerAuthed: "Read-only share · Open the generator to make your own",
    shareLoginToEdit: "Sign in",
    shareOpenGenerator: "Open generator",
    ...
    shareGalleryTitle: "Tables",
    shareGalleryLead: "Each table is a card. Click to preview.",
    shareCardPreview: "Preview",
    sharePreviewHint: "Drag to pan · Scroll to zoom · Esc to close",
